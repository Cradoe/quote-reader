const LoadAudioButton = ( { onClick, quoteId } ) => {
    return (
        <button aria-label="load audio" data-testid={`load-button-${quoteId}`} onClick={onClick} type="button" className="focus:animate-spin bg-white text-gray-900 dark:bg-gray-100 dark:text-gray-700 flex-none -my-2 mx-auto w-20 h-20 rounded-full ring-1 ring-gray-900/5 shadow-md flex items-center justify-center focus:outline-none">
